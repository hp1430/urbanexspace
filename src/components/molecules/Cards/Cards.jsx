...
export const Cards = () => {
    return (
        <div>
            <h1
                className="text-5xl font-semibold text-center mt-20 text-gray-800"
            >
                What We Offer ?
            </h1>
            <p
                className="text-4xl font-thin text-center text-black mt-10 mb-10 max-w-4xl mx-auto"
            >
            ...
            <p
                className="text-xl font-thin text-center text-black mt-10 mb-10 max-w-lg mx-auto"
            >
